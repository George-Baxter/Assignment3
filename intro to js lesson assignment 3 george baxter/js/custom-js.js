...
document.addEventListener('DOMContentLoaded', (loaded) => {
    ...
    document.getElementById("ex1").innerHTML = "<h5>Java Script Variables</h4>"+"<p>Let: The Value of C is: " + c + "</p>" +"<p>Const: The total is: " + total +"</p>";
    ...
    document.getElementById("name").innerHTML =
        "<h4>Java Script Variables</h4>"+"<p>TEST TEST TEST TEST</p>"+
        "<img id='logo' src='./img/logo.png' alt='header logo'>";
